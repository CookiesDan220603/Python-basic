...
## Ex7a
print("The maximize in vector x:", np.max(x))

## Ex7b
print("The minimize in vector x:", np.min(x))
...
for i in range(len(x)):
    if (x[i]<0 and x[i]%2==0):
        k.append(x[i])
print("The value < 0 and %2==0 is : ",k)
## Ex7 demo
print("The index of the values of x that < 0:", x[np.where(x<0)])
## Ex7c
